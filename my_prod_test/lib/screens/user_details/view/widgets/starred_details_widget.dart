...
class StarredDetailsWidget extends StatefulWidget {
  const StarredDetailsWidget({super.key});

  @override
  State<StarredDetailsWidget> createState() => StarredDetailsWidgetState();
}

class StarredDetailsWidgetState extends State<StarredDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder(
      ...
      builder: (context, UserDetailsState state) {
        final filteredRepos = state.starredResult?.where((repo) {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                repoDetails.stargazers.toString(),
